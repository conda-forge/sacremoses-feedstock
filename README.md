...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/sacremoses-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/sacremoses-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install sacremoses
```
...
It is possible to list all of the versions of `sacremoses` available on your platform:
...
```
pixi search sacremoses --channel conda-forge
```
